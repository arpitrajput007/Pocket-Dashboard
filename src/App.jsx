...
const AerediumTargets = lazy(() => import('./components/AerediumTargets'));
const LeadInbox = lazy(() => import('./components/LeadInbox'));
    ...
    <ErrorBoundary>
      <Suspense fallback={<LoadingFallback />}>
        <Routes>
          ...
          <Route path="/aeredium-targets" element={<AerediumTargets />} />
